        ...
        <div class="overflow-x-auto relative  sm:rounded-lg">
            ...
            <tbody>
                <tr
                    ...
                    <button @click="Update(item)" class="py-3 px-6">
                    ...
                    <button @click="Delete(item.CMND)" class="">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <div class="flex items-center justify-center min-h-screen">
                <div class="bg-gray-600 p-8 w-1/2 rounded">
                    ...
                    <form @submit.prevent="submitForm">
                        ...
                        <div class="mb-4 flex items-center">
                            <label class="block text-white text-sm font-semibold mb-2 w-24">Mã thẻ:</label>
                            <input id="MaThe" v-model="customersModal.dataCustomers.MaThe" type="text" class="border p-2 w-full" required />
                        </div>
...
export default {
    ...
    methods: {
        ...
        validateForm() {
            ...
            return this.customersModal.dataCustomers.CMND.trim() !== ''
            return this.customersModal.dataCustomers.HoVaTen.trim() !== ''
            return this.customersModal.dataCustomers.Email.trim() !== ''
            return this.customersModal.dataCustomers.SDT.trim() !== ''
            return this.customersModal.dataCustomers.NgaySinh.trim() !== ''
            return this.customersModal.dataCustomers.MaChiNhanh.trim() !== ''
        },
    },
}
</script>
